...
class ResponseFactory:
    ...
    @staticmethod
    def processing_success_with_optimization(
        data_type: str,
        traffic_light_id: str,
        timestamp: Union[str, int],
        optimization: Any,
        **kwargs,
        ...
        """Create a processing success response that includes the optimization data.

        This allows the caller (e.g. traffic-sim) to receive the OptimizationBatch
        generated by traffic-sync so it can apply the optimized times directly.
        """
        return ResponseFactory.success(
            "Data processed and optimized successfully",
            data_type=data_type,
